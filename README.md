...
## How we built it
We used Python to code the entire project and we used Ollama to locally run the LLMs as it makes extracting strucuted output from the LLM easy. Pydantic was also used to extract and validate the structured output from Qwen3.5:4b.
